...
<script src="<?php echo $uiURL; ?>plugins/apex/apexcharts.min.js"></script>
<script src="<?php echo $uiURL; ?>assets/js/widgets/modules-widgets.js"></script>
<script src="<?php echo $uiURL; ?>plugins/notification/snackbar/snackbar.min.js"></script>
<script src="<?php echo $uiURL; ?>assets/js/components/notification/custom-snackbar.js"></script>
<!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
<script src="<?php echo $basicURL; ?>js/functions/alert.js"></script>
<script src="<?php echo $basicURL; ?>js/functions/analytics.js"></script>
...
<script src="<?php echo $basicURL; ?>js/menuBar.js"></script>
<script src="<?php echo $basicURL; ?>js/navbar.js"></script>
<script src="<?php echo $basicURL; ?>js/receptionCustom.js"></script>
